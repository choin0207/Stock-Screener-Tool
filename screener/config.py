...
CONFIG = {
    ...
    # 散戶行情判定：漲停日法人合計未買超 且 當沖率 ≥ 此 % → 紅色警告
    ...
    # ---- 歷史回測訓練（screener/backtest.py，backtest-request.txt 觸發）----
    # 3 年：兼顧樣本數與制度一致性（2015/6 後漲跌幅 10%、2018 後才有合約負債科目）
    "backtest_days": 1095,             # 回測涵蓋的日曆天數
